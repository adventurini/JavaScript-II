...
//People who donated more than $200

let bigDonators=[];
bigDonators = runners.filter(runner=> runner.donation>=200);
console.log(bigDonators);

// Problem 2

//People with last name that starts with B
let lastNameB = [];
lastNameB = runners.filter(runner=> runner.last_name[0] === 'B');
console.log(lastNameB);

// Problem 3

//change everyone's email to Gmail
let gmail=[];
gmail = runners.map(runner=> runner.email = `${runner.first_name}${runner.last_name}@gmail.com`);
console.log(gmail);
